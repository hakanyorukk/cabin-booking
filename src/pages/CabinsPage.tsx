        ...
        <div className="grid grid-cols-2 h-full gap-20">
          {cabinsInfo.map((cabin) => {
            return (
              <div
                key={cabin.id}
                className="flex h-[18rem] border-2 border-slate-800 bg-transparent/20"
              >
                <div className="basis-[40%] overflow-hidden">
                  <img src={cabin.image} className="h-auto" />
                </div>
                <div className="flex flex-col basis-[60%] justify-between">
                  <div className="flex flex-col px-6 py-8 justify-between  h-full">
                    <div className="z-10">
                      ...
                      <p className="text-emerald-50 text-lg">{cabin.details}</p>
                    </div>
                    ...
                    <div>
                      <h2 className="text-slate-100 text-3xl justify-end flex">
                        $ {cabin.pricePerNight}
                        <span className="flex items-end text-lg px-2">
                          / night
                        </span>
                      </h2>
                    </div>
                  ...
                  <button
                    className="p-0 m-0 h-16 w-full text-slate-200 flex justify-center items-center text-xl main-button border-t border-slate-800"
